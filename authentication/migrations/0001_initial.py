# Generated by Django 2.2.5 on 2020-02-11 21:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default=None, max_length=200, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='authentication.Category')),
        ...
        migrations.AddField(
            model_name='customuser',
            name='card',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='authentication.CreditCard'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='groups',
